...
import { getNutrition, getNutritionSubtitle } from "../lib/fitData";
...
export function FitPage() {
  ...
  return (
    <div className="page">
      ...
      {/* Today's Training — always show if plan exists */}
      {trainingData?.today && (
        <>
          <TrainingCard
      ...
      {!trainingData?.plan && (
        <div className="card" style={{ textAlign: "center" }}>
          <div
            style={{ fontSize: 48, color: "var(--sand)", marginBottom: 16 }}
          >
            🏋️
          </div>
      ...
      {/* Nutrition recommendations — show when cycle data exists */}
      {cycleInfo && (
