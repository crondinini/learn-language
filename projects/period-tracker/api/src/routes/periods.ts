...
// Recalculate period start/end from its logged days
...
// Log flow for a day within a period
periodsRouter.post("/:id/days", async (c) => {
  ...
  // Check if a day entry already exists for this date
...
// Delete flow for a day within a period
